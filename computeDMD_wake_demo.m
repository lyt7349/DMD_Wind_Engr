%% Introduction 
%Introduction This computeDMD_wake_demo.m algorithm and sample data are
%based on the computeDMD.m algorithm from Kutz et al. (2016). To give full
%credit and for more details, readers shall refer to Chapter 2 of

%Kutz, J. N., Brunton, S. L., Brunton, B. W., & Proctor, J. L. (2016).
%Dynamic Mode Decomposition: Data-Driven Modeling of Complex Systems. In
%Society for Industrial and Applied Mathematics (Vol. 32, Issue 4).bSociety
...
%the cylinder wake. Author: Cruz Y. Li

%Download data file at Google Drive:
%https://drive.google.com/drive/folders/172EOM6GndRee4aR7rnkDpVSdARzpgaHB?usp=sharing
%Baidu Drive: https://pan.baidu.com/s/1xPYZhqsX_mwWZqYmQIZQxw?pwd=fywg
%Extraction code: fywg
